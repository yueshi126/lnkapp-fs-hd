...
public class CbsToa3000 {
    ...
    @DataField(seq = 10)
    @OneToMany(mappedTo = "org.fbi.fshd.domain.cbs.T3000Response.CbsToa3000Item", totalNumberField = "itemNum")
    private List<CbsToa3000Item> items;
    ...
    public List<CbsToa3000Item> getItems() {
        return items;
    }

    public void setItems(List<CbsToa3000Item> items) {
        this.items = items;
    }
